<script lang="ts" module>
	...
	export const buttonVariants = tv({
		base: [
			...
			'rounded-md border border-transparent bg-clip-padding text-base font-medium cursor-pointer group/button',
			'active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50',
			'focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-3',
			'aria-invalid:ring-3 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive dark:aria-invalid:border-destructive/50',
